...
DROP VIEW IF EXISTS AllProjectsWithHeadcount;
DROP VIEW IF EXISTS CurrentEmployeeAssignments;
...
CREATE TABLE Employee(
  ...
  EmpDate DATE,
  PRIMARY KEY(Ssn),
  FOREIGN KEY (Dno) REFERENCES Department(Dnumber) ON UPDATE CASCADE ON DELETE RESTRICT,
  FOREIGN KEY (Super_ssn) REFERENCES Employee(Ssn) ON UPDATE CASCADE ON DELETE SET NULL DEFERRABLE INITIALLY DEFERRED
);
...
CREATE TABLE Project(
  ...
  Dnum INT NOT NULL,
  PRIMARY KEY(Pnumber),
  FOREIGN KEY (Dnum) REFERENCES Department(Dnumber) ON UPDATE CASCADE ON DELETE RESTRICT
);
...
CREATE TABLE Works_On(
  ...
  FOREIGN KEY (Essn) REFERENCES Employee(Ssn) ON UPDATE CASCADE ON DELETE RESTRICT,
...
('Sebastian', 'T', 'Kuras', '111111111', 'Houston, TX', 'M', 90000, NULL, 5, '1965-05-19', '1985-09-14'),
('Alex', 'E', 'Vermeulen', '111222333', 'Dundas, ON', 'F', 150000, NULL, 5, '1992-04-01', '2014-09-29'),
...
('Tamara', 'E', 'Walters', '198928552', 'Hamilton, ON', 'F', 980000, NULL, 4, '1967-11-17', '1989-07-20'),
...
('Samuel', 'C', 'Anderson', '199196331', 'Paris, ON', 'M', 240000, NULL, 24, '1999-12-19', '2020-08-29'),
('Andrea', 'R', 'Austin', '199302835', 'Hamilton, ON', 'M', 160000, '333445555', 5, '1963-08-30', '1983-12-03'),
('Fahad', 'Y', 'Selles', '199305628', 'Guelph, ON', 'M', 40000, NULL, 5, '1974-01-11', '1996-04-11'),
('Jack', 'U', 'Nicholson', '199489442', 'Guelph, ON', 'M', 80000, NULL, 5, '1994-05-31', '2019-02-25'),
('Robert', 'I', 'De Niro', '199608611', 'Hamilton, ON', 'M', 100000, NULL, 4, '1976-08-26', '2000-07-10'),
('Jennifer', 'X', 'Armstrong', '199685000', 'Guelph, ON', 'F', 130000, NULL, 7, '1993-08-06', '2017-10-14'),
('Rajan', 'C', 'Patel', '199705791', 'Paris, ON', 'M', 164000, NULL, 11, '1982-12-02', '2006-12-17'),
('Emily', 'V', 'Asher', '199923690', 'London, ON', 'F', 10000, NULL, 5, '1985-04-22', '2006-01-30'),
...
('Tom', 'E', 'Hanks', '200352295', 'Paris, ON', 'M', 197000, NULL, 4, '1977-10-29', '1998-11-07'),
...
('Maral', 'X', 'Branda', '200626576', 'Guelph, ON', 'F', 56000, '359624751', 11, '1970-11-26', '1992-09-20'),
...
('Jared', 'K', 'Aziz', '201165466', 'London, ON', 'M', 50000, NULL, 4, '1990-12-15', '2011-05-20'),
('Emma', 'L', 'Azizi', '201272287', 'Hamilton, ON', 'F', 40000, '123456789', 24, '1988-10-03', '2013-05-11'),
('Kelly', 'W', 'Barham', '201443758', 'Hamilton, ON', 'F', 140000, NULL, 24, '1989-03-06', '2009-07-15'),
...
('MacKenzie', 'A', 'Barsky', '201774583', 'Paris, ON', 'M', 99000, NULL, 4, '1986-06-29', '2008-01-01'),
...
('Cassandra', 'D', 'Jonesboro', '202247633', 'Guelph, ON', 'F', 80000, NULL, 4, '1983-04-06', '2006-06-25'),
('Kaitlyn', 'G', 'Anderson', '202428993', 'Paris, ON', 'F', 84000, NULL, 1, '1996-05-16', '2016-11-15'),
('Aaron', 'Z', 'Austin', '202561262', 'Guelph, ON', 'M', 86000, NULL, 24, '1988-07-22', '2011-07-08'),
('Tony', 'W', 'Saunders', '202561319', 'Hamilton, ON', 'M', 86000, '333445555', 4, '1993-10-05', '2017-01-24'),
('Emily', 'S', 'Nicholson', '202744742', 'London, ON', 'F', 50000, NULL, 4, '1971-03-10', '1995-08-14'),
('Karly', 'A', 'Selles', '202785848', 'Paris, ON', 'F', 100000, NULL, 4, '1974-09-22', '1998-04-21'),
('Laurence', 'C', 'De Niro', '202860324', 'Hamilton, ON', 'M', 40000, NULL, 5, '1977-10-20', '1999-11-15'),
('Valentine', 'X', 'Muravyov', '218167890', 'Waldorf, MD', 'M', 80000, '444555777', 2, '1997-09-07', '2020-06-15'),
('Tushar', 'L', 'Dobhal', '222222222', 'Houston, TX', 'M', 70000, NULL, 5, '1999-12-03', '2022-03-06'),
('James', 'O', 'Bond', '231456456', 'London, On', 'M', 25000, NULL, 1, '1993-11-04', '2013-11-11'),
...
('Shuchi', 'A', 'Pandit', '296045397', 'Guelph, ON', 'F', 980000, NULL, 4, '1985-05-06', '2007-10-29'),
('Melissa', 'K', 'Iv', '306737594', 'Toronto, On', 'F', 164000, '460836586', 11, '1994-06-03', '2017-02-11'),
('Heidi', 'N', 'Klum', '315565726', 'Guelph, ON', 'F', 240000, NULL, 24, '1974-08-23', '1998-06-27'),
...
('Alex', 'Q', 'Gaijic', '333333333', 'Houston, TX', 'M', 40000, NULL, 5, '1964-06-21', '1987-04-25'),
('Frank', 'T', 'Wong', '333445555', 'Houston, TX', 'M', 80000, NULL, 5, '1997-06-26', '2020-10-28'),
('Trevor', 'T', 'Davis', '338888555', 'Almonte, ON', 'M', 100000, NULL, 4, '1996-03-24', '2020-11-28'),
('Josiah', 'H', 'Timmins', '353467409', 'Guelph, ON', 'M', 130000, NULL, 7, '1983-09-21', '2008-05-18'),
('Cindy', 'H', 'Crawford', '359624751', 'Toronto, On', 'F', 164000, NULL, 11, '1986-02-21', '2009-12-25'),
('Mohammad', 'P', 'Ali', '444444444', 'Houston, TX', 'M', 10000, NULL, 5, '1995-10-03', '2019-05-15'),
...
('Carmel', 'D', 'Schembri', '460836586', 'Guelph, On', 'M', 197000, NULL, 4, '1992-05-29', '2012-07-05'),
...
('Delores', 'E', 'Patterson', '606088000', 'Orangeville, ON', 'F', 50000, NULL, 4, '1988-04-04', '2008-06-12'),
...
('Brooklyn', 'N', 'Decker', '629575266', 'Guelph, ON', 'F', 140000, NULL, 24, '1965-11-27', '1985-11-30'),
('Carolyn', 'D', 'Dattilo', '631541234', 'Redmond, WA', 'F', 70000, '444555777', 2, '1991-12-10', '2015-01-10'),
('Imran', 'Z', 'Kanji', '666258951', 'Guelph, On', 'M', 99000, NULL, 4, '1966-12-08', '1991-01-31'),
('Test', 'E', 'Idle', '123450000', 'N/A', 'M', 50000, NULL, 1, '1990-01-01', '2010-01-01');
...
CREATE OR REPLACE VIEW CurrentEmployeeAssignments AS
SELECT e.Ssn, e.Fname, e.Lname, w.Pno, w.Hours
FROM Employee e
JOIN Works_On w ON w.Essn = e.Ssn;

CREATE OR REPLACE VIEW AllProjectsWithHeadcount AS
SELECT p.Pnumber, p.Pname, p.Dnum,
